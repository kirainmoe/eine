...
export declare enum MessageComponentTypeStr {
    SOURCE = "Source",
    QUOTE = "Quote",
    AT = "At",
    AT_ALL = "AtAll",
...
/** 支持的消息类型 */
export declare type MessageComponentType = Source | Quote | At | AtAll | Face | Plain | Image | FlashImage | Voice | Xml | Json | App | Poke | Dice | MusicShare | ForwardMessage | File | PreloadFile;
/** 消息链数组 */
export declare type MessageChain = (string | MessageComponentType)[];
/** 转发消息节点元素 */
...
/** 转发消息节点 */
export declare type ForwardNodeList = ForwardNodeListItem[];
/** 消息来源 */
...
export interface PreloadFile {
    ...
    originType: MessageComponentTypeStr.IMAGE | MessageComponentTypeStr.FLASH_IMAGE | MessageComponentTypeStr.VOICE | MessageComponentTypeStr.FILE;
