...
class EineLogger {
    ...
    essentialInfo(message, ...args) {
        console.log(chalk_1.default.bgCyan("INFO"), `${chalk_1.default.gray(this.prefix)}`, `${chalk_1.default.gray(this.getTimeString())}`, this.formatString(message, ...args));
    }
}
