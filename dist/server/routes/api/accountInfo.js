...
function accountInfo(_a) {
    var req = _a.req, res = _a.res, eine = _a.eine, db = _a.db, server = _a.server;
    return __awaiter(this, void 0, void 0, function () {
        var profile, friendList, groupList;
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 2:
                    ...
                    return [4 /*yield*/, eine.pickBest().botProfile()];
                case 3:
                    profile = _b.sent();
                    return [4 /*yield*/, eine.pickBest().friendList()];
                case 4:
                    friendList = _b.sent();
                    return [4 /*yield*/, eine.pickBest().groupList()];
                case 5:
                    groupList = _b.sent();
                    res.status(200).json({
                        code: 0,
