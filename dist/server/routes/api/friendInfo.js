        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 2:
                    ...
                    return [4 /*yield*/, eine.pickBest().friendProfile(req.query.friendId)];
                case 3:
                    friendInfo_1 = _b.sent();
                    res.status(200).json({
                        code: 0,
                        status: "success",
                        payload: friendInfo_1,
                    });
                    _b.label = 4;
...
exports.default = {
    ...
    validator: [
        ...
        express_validator_1.check("uid")
            .isInt()
            .bail(),
        express_validator_1.check("friendId")
            .isInt()
            .bail()
    ]
};
