        ...
        return __generator(this, function (_g) {
            switch (_g.label) {
                ...
                case 2:
                    ...
                    return [4 /*yield*/, eine.pickBest().getGroupConfig(req.query.groupId)];
                case 3:
                    groupInfo_1 = _g.sent();
                    ...
                    _d = [__assign({}, groupInfo_1)];
                    _f = {};
                    return [4 /*yield*/, eine.pickBest().memberList(req.query.groupId)];
                case 4:
                    _c.apply(_b, [(_e.payload = __assign.apply(void 0, _d.concat([(_f.members = _g.sent(), _f)])),
                            _e)]);
                    _g.label = 5;
