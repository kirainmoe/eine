...
function install(_a) {
    ...
    return __awaiter(this, void 0, void 0, function () {
        var errors, isInstalled, _b, username, password;
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0:
                    ...
                    return [4 /*yield*/, db.countUser({ role: 0 })];
                case 1:
                    isInstalled = _c.sent();
                    if (isInstalled > 0) {
                    ...
                    return [4 /*yield*/, db.createUser(username, password, types_1.EineUserRole.MASTER)];
                case 2:
                    _c.sent();
